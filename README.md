...
A compilation of R code to compute and model ecosystem stability metrics (resilience) from remotely-sensed time series of forest evapotranspiration (ET). This release has been published on Zenodo: [![DOI](https://zenodo.org/badge/315108702.svg)](https://zenodo.org/badge/latestdoi/315108702)
