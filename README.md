...
### StabilityMetrics.R
Compute the resistance and resilience of ET anomalies obtained by running Evapotranspiration.R. Resistance is computed on the scaled ET anomaly (&#10698;<sub>ET</sub> &#x220A;):
